...
Updated files:
- `src/component2/config.py` (added M2 runtime defaults: `message_passing_layers`, `ppr_alpha`, `ppr_max_iters`, `ppr_tolerance`)
...
Bridge scores from smoke run (`logs/component2/m2/20260210_075756/predictions.jsonl`):
...
- `converged=false`, `iterations=64`, `residual_l1=6.08e-05`
...
Run directory:
- `logs/component2/m2/20260210_075756/`

Files:
- `logs/component2/m2/20260210_075756/run_config.json`
- `logs/component2/m2/20260210_075756/summary.json`
- `logs/component2/m2/20260210_075756/predictions.jsonl`
...
- Latest validation run:
  - `PYTHONPATH=src python3 -m unittest discover -s tests/component2 -v` → 15 tests passed.
  - `PYTHONPATH=src python3 -m component2.run_m2 --max-claims 5 --output-root logs/component2`
  - Output path: `logs/component2/m2/20260210_075756/`.
