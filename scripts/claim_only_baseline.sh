...
TRAIN_SUBSET="${CLAIM_ONLY_TRAIN_SUBSET:-10000}"
VAL_SUBSET="${CLAIM_ONLY_VAL_SUBSET:-2000}"
STAGE1_EPOCHS="${CLAIM_ONLY_STAGE1_EPOCHS:-4}"
STAGE2_EPOCHS="${CLAIM_ONLY_STAGE2_EPOCHS:-2}"

cmd=(
  python -m component3.run_train
  --run-id "${RUN_ID}"
  --dataset-name factkg
  --model-mode claim_only
  --encoder_tune none
